        ...
        <div className="col-12 col-lg-10">
            <div className="row">
                {productos.map((elemento)=>
                    <div  className="carta col-12 col-md-6 col-lg-4 col-xl-3" key={elemento.id}>
                        <div>
                            ...
                            <h4 className="precio-categorias precio">Precio contado: <span className="precio-detail-numero">{`$${elemento.price}`}</span>
                            </h4>
                            <p style={elemento.stock>2 ? {color: "green"} : {color:"red"}} className="stock">stock: {elemento.stock}
                            </p>
